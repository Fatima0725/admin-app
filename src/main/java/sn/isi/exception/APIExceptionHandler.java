...
public class APIExceptionHandler {
    ...
    public ResponseEntity<APIException> handleEntityNotFoundException(NumberFormatException e) {
    ...
    public ResponseEntity<APIException> handleEntityNotFoundException(MethodArgumentNotValidException e) {
